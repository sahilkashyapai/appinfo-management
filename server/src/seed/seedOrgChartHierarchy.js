...
async function main() {
  ...
  const branchA = [
    ...
    { name: 'Yash Malhotra', desig: 'Senior Software Engineer', roleLabel: 'Senior Engineer', dept: 'Dot Net', managerRef: byName['Aman Chopra']._id },
    { name: 'Ishaan Kulkarni', desig: 'Software Engineer', roleLabel: 'Engineer / Developer', dept: 'Dot Net', managerRef: byName['Yash Malhotra']._id },
  ...
  const branchB = [
    ...
    { name: 'Lakshmi Pillai', desig: 'Senior QA Engineer', roleLabel: 'Senior Engineer', dept: 'Quality Assurance', managerRef: byName['Meera Kapoor']._id },
    { name: 'Divya Menon', desig: 'QA Engineer', roleLabel: 'Engineer / Developer', dept: 'Quality Assurance', managerRef: byName['Lakshmi Pillai']._id },
